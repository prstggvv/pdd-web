...
export const PROBLEMS_LIST: string[] = [
  'Срывы сроков из-за разрозненных подрядчиков.',
  'Проекты ОДД, которые не работают в реальных условиях.',
  'Ошибки во временных схемах движения на действующих объектах.',
